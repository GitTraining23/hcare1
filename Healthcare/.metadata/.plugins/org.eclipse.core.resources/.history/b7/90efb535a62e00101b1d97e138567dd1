...
public class AddVitalTest extends BaseClass {
	...
	public void addVitals() throws InterruptedException, IOException {
		lt.excuteLoginTest();
		...
		//addExplicitWait(AddVitalDetailsPage.recordVitals());
		//driver.findElement(AddVitalDetailsPage.recordVitals()).click();
		...
		WebElement punc=driver.findElement(AddVitalDetailPage.select_punctuality());
			...
			addImplicitWait();
			String vitname=FetchDataFromProp.readDataFromProp().getProperty("patFullName");
			addImplicitWait();
			Thread.sleep(3000);
			driver.findElement(By.linkText(vitname)).click();
			...
			driver.findElement(AddVitalDetailPage.add_Temp()).sendKeys("37");
			...
			driver.findElement(AddVitalDetailPage.add_Respiration()).sendKeys("6");
			...
			//checking vital history under vitals biometric
			String expected=driver.findElement(AddVitalDetailPage.check_vitalHistory()).getText();
			String Actual="Vitals history";
			Assert.assertEquals(Actual, expected);
			
			addExplicitWait(AddVitalDetailPage.click_Actions());
			driver.findElement(AddVitalDetailPage.click_Actions()).click();
			addImplicitWait();
			
			addExplicitWait(AddVitalDetailPage.click_endVisit());
			driver.findElement(AddVitalDetailPage.click_endVisit()).click();
			addImplicitWait();
			
			addExplicitWait(AddVitalDetailPage.cofirm_endVisit());
			driver.findElement(AddVitalDetailPage.cofirm_endVisit()).click();
			addImplicitWait();
			
			addExplicitWait(AddVitalDetailPage.gobackToHome());
			driver.findElement(AddVitalDetailPage.gobackToHome()).click();
			addImplicitWait();
